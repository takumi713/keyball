...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_universal(
    RGB_TOG  , AML_TO   , AML_I50  , AML_D50  , _______  , _______  ,       _______  ,  KC_LAUNCHPAD  , KC_MISSION_CONTROL  , _______ ,  _______ ,  _______  ,
    RGB_MOD  , RGB_HUI  , RGB_SAI  , RGB_VAI  , _______  , SCRL_DVI ,      _______  , KC_BTN1  , KC_BTN2  , KC_BTN3 , _______  , _______  ,
  ...
  KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,       KC_N     , KC_M     , DV_W  , DV_V   , DV_Z , DV_TILD  ,
            KC_LALT, TO_JIS, KC_LGUI   , LT(5,KC_SPC), LT(7,DV_EQL),     KC_ENT, DV_BSLS, _______, _______ , LT(3,KC_ESC)
),
// dvorak > 1
  [5] = LAYOUT_universal(
  KC_TAB   , KC_Q     , KC_W     , KC_E     , KC_R     , KC_T     ,       KC_Y     , KC_U     , KC_I     , KC_O     , KC_P     , DV_SLSH   ,
  ...
  KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,       KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_MINS  ,
            KC_LALT, TO_JIS, KC_LGUI   , LT(1,DV_2), LT(3,DV_EQL),       KC_BSPC, KC_TRNS, _______, _______ , KC_SPC
),
// dvorak > 2
  [6] = LAYOUT_universal(
  KC_TAB   , KC_Q     , KC_W     , KC_E     , KC_R     , KC_T     ,       KC_Y     , KC_U     , KC_I     , KC_O     , KC_P     , DV_SLSH   ,
  KC_LCTL  , KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,       KC_H     , KC_J     , KC_K     , KC_L     , LT(3,DV_S)  , DV_MINS  ,
  KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,       KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_MINS  ,
            KC_LALT, TO_JIS, KC_LGUI   , LT(1,DV_2), LT(3,DV_EQL),      KC_BSPC, KC_TRNS, _______, _______ , KC_ESC
),
// dvorak > 3
  [7] = LAYOUT_universal(
  RGB_TOG  , AML_TO   , AML_I50  , AML_D50  , _______  , _______  ,       _______  ,  KC_LAUNCHPAD  , KC_MISSION_CONTROL  , _______ ,  _______ ,  _______  ,
