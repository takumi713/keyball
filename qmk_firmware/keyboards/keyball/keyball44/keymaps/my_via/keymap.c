...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    KC_LCTL  , KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,      KC_H     , KC_J     , LT(1, KC_K)     , KC_L     , LT(3,KC_SCLN)  , KC_ENT  ,
    KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,      KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  ,   KC_RSFT, // 「とか使いたくね
  ...
  KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,       KC_N     , KC_M     , DV_W  , DV_V   , DV_Z , TILD_SHIFT  ,
...
// dvorak > 1
  ...
  SSNP_FRE ,  KC_F1   , KC_F2    , KC_F3   , KC_F4    , KC_F5   ,       KC_F6    , KC_F7    , KC_F8    , KC_F9    , KC_F10   , KC_F11   ,
    ...
    SSNP_HOR ,  _______ , _______  , _______ , _______  , _______  ,       KC_PGDN  , ZOOM_IN  , _______  , _______  , _______  , _______  ,
              _______  , _______ , _______  ,  _______  , _______  ,         GO_PREVIOUS_WINDOW  , GO_NEXT_WINDOW  , _______       , _______  , _______
),
// dvorak > 2
  [6] = LAYOUT_universal(
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        ...
        static uint16_t tilde_timer;
        case TILD_SHIFT:
            if (record->event.pressed){
              tilde_timer = timer_read();
              register_code(KC_LSFT);
            } else {
              if (timer_elapsed(tilde_timer) < TAPPING_TERM){
                unregister_code(KC_LSFT);
                tap_code16(DV_TILD);
              } else {
                unregister_code(KC_LSFT);
